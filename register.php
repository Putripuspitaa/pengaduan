                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-6 font-weight-bold   " style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">REGISTRASI</h1>
                                        <font face="Verdana">
                                            <h5 style="color: #4d4d33;">Pengaduan Masyarakat</h5>
                                        </font>
                                    </div>
                                    <br>
                                    <form class="user" method="post" action="simpan_masyarakat.php">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="telp" class="form-control form-control-user" placeholder="Masukkan No. Telp...">
                                        </div>
                                        <hr>
